...
import { analysisDownloadFilename, detailForAnalysis, resultFixtureRecords } from '../lib/result-capture.ts';
...
test('legacy date-grouped result snapshots remain readable in AI exports', () => {
  ...
  assert.equal(resultFixtureRecords({ responses: [{ date: '2026-09-08', response: [{ fixture: { id: 8 } }] }] }).length, 1);
});
