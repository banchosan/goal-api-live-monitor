...
export async function GET(request: Request) {
  ...
  for (const fixtureId of new Set([...grouped.keys(), ...snapshotsByFixture.keys()])) {
    ...
    if (snapshotHistory.length) {
      ...
      let ht: SnapshotRow | null = null; let ko: SnapshotRow | null = null; let cutoff65: SnapshotRow | null = null; let checkpoint70: SnapshotRow | null = null; let checkpoint75: SnapshotRow | null = null;
      ...
      fixtures[fixtureId] = {
        ...
        minute75Stats: checkpoint75 ? savedStats(checkpoint75.rawStatisticsJson) : null, minute75: checkpoint75?.elapsedMinute ?? null, historyFallback: true,
      };
      continue;
    }
