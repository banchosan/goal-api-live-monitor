...
function isSelectedLeague(fixture: UpcomingFixture) {
  ...
  const exact: Record<string, string[]> = {
    england: ['premier league', 'championship', 'league one', 'league two', 'efl league one', 'efl league two', 'national league', 'vanarama national league'],
    ...
    france: ['ligue 1', 'ligue 2', 'national', 'national 1', 'championnat national', 'league 3', 'french league 3', 'national u19', 'u19 national'],
    ...
    turkey: ['super lig', 'superlig', '1. lig', '1 lig', '2. lig', '2 lig', 'tff 2. lig', 'turkish second league'],
    turkiye: ['super lig', 'superlig', '1. lig', '1 lig', '2. lig', '2 lig', 'tff 2. lig', 'turkish second league'],
    ...
    indonesia: ['liga 1', 'league 1', 'super league', 'indonesia super league'],
    norway: ['eliteserien', '1st division', '1. division', 'division 1', 'obos-ligaen', 'obos ligaen', '2nd division', '2. division', 'division 2'],
    ...
    latvia: ['virsliga', 'higher league', 'latvian higher league', '1st division', 'first division', 'division 1'],
